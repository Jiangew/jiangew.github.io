---
title: "深入浅出 gRPC 01：gRPC 入门及服务端创建和调用原理"
layout: post
date: 2018-03-12 18:40
...
# 深入浅出 gRPC 01：gRPC 入门及服务端创建和调用原理

## 1. RPC 入门

### 1.1 RPC 框架原理
RPC 框架的目标就是让远程服务调用更加简单、透明，RPC 框架负责屏蔽底层的传输方式（TCP 或者 UDP）、序列化方式（XML/Json/ 二进制）和通信细节。服务调用者可以像调用本地接口一样调用远程的服务提供者，而不需要关心底层通信细节和调用过程。<br />
RPC 框架的调用原理图如下所示：
![](/assets/images/post/201810131/grpc-01-01.png)<br>
...
#### 1.3.1 gRPC 概览
gRPC 是由 Google 开发并开源的一种语言中立的 RPC 框架，当前支持 C、Java 和 Go 语言，其中 C 版本支持 C、C++、Node.js、C# 等。当前 Java 版本最新 Release 版为 1.5.0，Git 地址如下：[grpc-java](https://github.com/grpc/grpc-java)

gRPC 的调用示例如下所示：
![](/assets/images/post/201810131/grpc-01-02.png)<br>
...
下面我们看下 gRPC 服务端创建流程：
![](/assets/images/post/201810131/grpc-01-03.png)<br>
...
gRPC 请求消息接入流程如下：
![](/assets/images/post/201810131/grpc-01-04.png)<br>
...
![](/assets/images/post/201810131/grpc-01-05.png)<br>
...
![](/assets/images/post/201810131/grpc-01-06.png)<br>
...
![](/assets/images/post/201810131/grpc-01-07.png)<br>
...
具体流程如下所示：
![](/assets/images/post/201810131/grpc-01-08.png)<br>
...
![](/assets/images/post/201810131/grpc-01-09.png)<br>
...
#### 3.1.1 gRPC 请求消息头处理
![](/assets/images/post/201810131/grpc-01-10.png)<br>
...
![](/assets/images/post/201810131/grpc-01-11.png)<br>

#### 3.1.3 gRPC 响应消息处理
![](/assets/images/post/201810131/grpc-01-12.png)<br>
...
![](/assets/images/post/201810131/grpc-01-13.png)<br>
...
![](/assets/images/post/201810131/grpc-01-14.png)<br>
...
![](/assets/images/post/201810131/grpc-01-15.png)<br>
...
![](/assets/images/post/201810131/grpc-01-16.png)<br>
...
> 原文链接：https://time.geekbang.org/column/article/4435
> 版权归极客邦科技所有，未经许可不得转载
